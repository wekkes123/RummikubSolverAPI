...
"""
ar [tiles] - Add tiles to your rack (e.g., ar r5 r6 r7 j to add red 5, red 6, red 7, and a joker)
r - View tiles on your rack
t - View tiles on the table
solve - Find the optimal move with the current rack and table
solve tiles - Optimize for maximum number of tiles played
solve value - Optimize for maximum point value
solve initial - Find initial meld (needs 30+ points)
r2t [tiles] - Move tiles from rack to table
t2r [tiles] - Move tiles from table to rack
quit or stop or end - Exit the program
"""
